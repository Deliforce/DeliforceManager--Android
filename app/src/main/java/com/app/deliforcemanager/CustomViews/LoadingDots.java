...
public class LoadingDots extends LinearLayout {
    ...
    private void initializeDots(Context context) {
        ...
        ViewGroup.LayoutParams dotParams = new ViewGroup.LayoutParams(mDotSize, mDotSize);
        ViewGroup.LayoutParams spaceParams = new ViewGroup.LayoutParams(mDotSpace, mDotSize);
        for (int i = 0; i < mDotsCount; i++) {
            // Add dot
